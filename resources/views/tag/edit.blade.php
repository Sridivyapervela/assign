                    ...
                    <div class="card-body">
                        <form action="/tag/{{$tag->id}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control {{ $errors->has('description') ? 'border-danger' : ''}}" id="style" name="style" rows="5" value="{{ $tag->style ?? old('name')}}"></textarea>
                                <small class="form-element text-danger">{!! $errors->first('style') !!}</small>
                            </div>
