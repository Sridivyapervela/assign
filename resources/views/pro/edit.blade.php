                    ...
                    <div class="card-body">
                        <form autocomplete="off" action="/pro/{{ $pro->id}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ $errors->has('name') ? 'border-danger' : ''}}" id="name" name="name" value="{{ $pro->name ?? old('name')}}" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control {{ $errors->has('description') ? 'border-danger' : ''}}" id="description" name="description" rows="5" value="{{ $pro->description ?? old('name')}}"></textarea>
                                <small class="form-element text-danger">{!! $errors->first('description') !!}</small>
                            </div>
